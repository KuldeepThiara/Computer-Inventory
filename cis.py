...
class LoginPage(ttk.Frame):
    ...
    def Login_widget(self):
        ...
        self.frame = Frame(self, width="1200", height="650", background="#ede9e3")
        ...
        login_label = Label(frame_login, text="Login", bg = "#fffff0", font=("canterall",32, "bold") )
        ...
        username_label = Label(frame_login, text="USERNAME",bg = "#fffff0", font=("canterall", 12))
        username_label.grid(row=5, column=0, sticky=W)

        # Username entry field inside frame_login frame
        username_entry= Entry(frame_login,width=20, borderwidth="2", bg = "white")
        username_entry.grid(row=6, column=0, sticky=W)

        # Password label inside frame_login frame
        password_label = Label(frame_login, text="PASSWORD",bg = "#fffff0", font=("canterall", 12))
        ...
        Login_Button = Button(frame_login, text="  Login  ", bg = "#63ec69", command=lambda:login())
...
class SelectionPage(ttk.Frame):
    ...
    def success_widget(self):
        ...
        Topbar_Frame = LabelFrame(self.Selection_Frame, bg = "#fffff0", width=1200, height=50)
        ...
        Selection_Frame = Frame(self.Selection_Frame, bg = "#fffff0", width =1200, height=550)

        # Created "Make a selection!" label inside Selection_Frame frame
        Selection_label = Label(Selection_Frame, text="Make a selection!",font=("canterall",30, "bold"), fg="#d9d9d9", bg = "#fffff0")
        ...
        Exit_Frame = Frame(self.Selection_Frame, bg = "#fffff0", width =1200, height=50)
...
class SearchPage(ttk.Frame):
    ...
    def Search_widget(self):
        ...
        Topbar_Frame = LabelFrame(self.Search_Frame, bg = "#fffff0", width=1200, height=50)
        ...
        # Selection_Frame frame to be placed right under the Topbar_Frame frame
        Selection_Frame = Frame(self.Search_Frame, bg = "#fffff0",  height=550, width=1200)


        #Frame to display results
        resultFrame = Frame(Selection_Frame, bg = "#fffff0", height=550, width=600)

        columns = ('Model', 'Quantity')


        #Treeview list will display results for the searched query
        resultList = ttk.Treeview(resultFrame, columns=columns, show='headings')
        ...
        def searchModel():
                ...
                computer = cInventory.search_model(key) # searching for the entered model


                #Inseting the data that is returned by searched query inside Treeview list.
                if computer == (key, None):
                    resultList.insert('', 'end',values=(key , "No data for the entery searched"))
                else:
        ...
        def searchDate():
                ...
                resultList2 = ttk.Treeview(resultFrame, columns=columnsForDate, show='headings')
                ...
                computer = cInventory.search_Date(key) # searching for the entered date


                #Inseting the data that is returned by searched query inside Treeview list
                if computer == ([]):
                    resultList2.insert('', 'end',values=("No data", "No data", "No data"))
                else:
                    for x in computer:
        ...
        optionFrame = Frame(Selection_Frame, bg = "#fffff0", height=550, width=600, padx=125, pady=125)

        # Created "Model" label to be placed inside Selection_Frame
        Model_label = Label(optionFrame, text="Model",bg = "#fffff0", font=("canterall", 14, "bold"))
        ...
        Search_Button = Button(optionFrame, text="Search",  bg = "#63ec69", width=100, height=30, command=searchModel)
        Search_Button.grid(row=1, column=2, sticky=W)

        # A "Date" label to placed on top date entry field
        Date_label = Label(optionFrame, text="Date",bg = "#fffff0", font=("canterall", 14, "bold"))
        ...
        Searchall_Button = Button(optionFrame, text="Search All",  bg = "#63ec69", width=100, height=30, command=searchDate)
        ...
        # Exit_Frame frame to store the exit button in the lower section of the window
        Exit_Frame = Frame(self.Search_Frame, bg = "#fffff0", width =1200, height=50)
...
class UpdatePage(ttk.Frame):
    ...
    def Update_widget(self):
        ...
        Topbar_Frame = LabelFrame(self.Update_Frame, bg = "#fffff0", width=1200, height=50)
        ...
        # Selection_Frame frame to be placed right under the Topbar_Frame frame
        Selection_Frame = Frame(self.Update_Frame, bg = "#fffff0", width =1200, height=550)

        #Frame to display results
        resultFrame = Frame(Selection_Frame, bg = "#fffff0", height=550, width=600, padx=125)

        #Result label for quanity saved
        result_label = Label(resultFrame, text=" ",bg = "#fffff0", font=("canterall", 14, "bold"))
        ...
        # Frame to display options that the user will have for search
        optionFrame = Frame(Selection_Frame, bg = "#fffff0", height=500, width=600, padx=150, pady=150)

        # Created "Select Model" label to be placed inside Selection_Frame
        Selectmodel_label = Label(optionFrame, text="Select Model ",bg = "#fffff0", font=("canterall", 14, "bold"))
        ...
        def updateQuantity():
            cInventory.write_inventory("Inventory.csv", model.get(), quantity(), "Update")
            result_label.config(text = ('Quantity updated for the selected model to ' + str(quantity())))


        # Dropdown menu to select the model to update the quanity
        Selectmodel_dropmenu = OptionMenu( optionFrame , model, *computers, command = selectedModel )
        ...
        Quantity_label = Label(optionFrame, text="Quanity",bg = "#fffff0", font=("canterall", 14, "bold"))
        Quantity_label.grid(row=1, column=0, sticky=W)

        # Quanity entry field to enter the amount of Laptops in stock
        Quantity_entry= Entry(optionFrame,width=20, borderwidth="2", bg = "white")
        Quantity_entry.grid(row=1, column=1, sticky=W)

        # Save button to save the quanity of laptops that were entered in entry field
        Save_Button = Button(optionFrame, text="Save",  bg = "#3b87d5", width=100, height=30, command=updateQuantity)
        ...
        # Exit_Frame frame to store the exit button in the lower section of the window
        Exit_Frame = Frame(self.Update_Frame, bg = "#fffff0", width =1200, height=50)
...
class AddModelPage(ttk.Frame):
    ...
    def AddModel_widget(self):
        ...
        def addModel():
            cInventory.write_inventory("Inventory.csv", Model_entry.get(), 0, "Add")
            result_label.config(text = 'Entered Model "' + Model_entry.get() +'" has been added to the list' )
        ...
        Topbar_Frame = LabelFrame(self.AddModel_Frame, bg = "#d9d9d9", width=1200, height=50)
        ...
        Selection_Frame = Frame(self.AddModel_Frame, bg = "#fffff0", width =1200, height=550)
        ...
        # Frame to display options that the user will have for search
        optionFrame = Frame(Selection_Frame, bg = "#fffff0", height=550, width=600, padx=150, pady=150)

        # Created "Model Name" label to be placed inside Selection_Frame
        AddModel_label = Label(optionFrame, text="Model Name ",bg = "#fffff0", font=("canterall", 14, "bold"))
        ...
        Add_Button = Button(optionFrame, text="Add",  bg = "#3b87d5", width=180, height=30, command=addModel)
        ...
        # Exit_Frame frame to store the exit button in the lower section of the window
        Exit_Frame = Frame(self.AddModel_Frame, bg = "#fffff0", width =1200, height= 50)
...
class AllModelPage(ttk.Frame):
    ...
    def AddModel_widget(self):
        ...
        AddModel_label = Label(Selection_Frame, text="All Models Listed Below ",bg = "#fffff0", font=("canterall", 14))
        AddModel_label.place(relx=.5, rely=.32, anchor=CENTER)

        # Frame to to placed the list box inside
        Listbox_Frame = Frame(Selection_Frame, bg = "#fffff0", width =200, height=300)
        ...
        Refresh_Button = Button(Selection_Frame, text="Refresh",  bg = "#3b87d5", width=100, height=30, command=refresh)
